...
async function renderDiagnosis() {
  ...
  el.innerHTML =
    '<div class="nav">'
    + '<button onclick="history.back()" style="background:none;border:none;color:var(--t3);font-size:14px;cursor:pointer;font-weight:700;font-family:inherit;display:flex;align-items:center;gap:5px">'
